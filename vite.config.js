  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: '/Justify/',
        icons: [
          { src: '/Justify/icons/icon-192.png', sizes: '192x192', type: 'image/png', purpose: 'any maskable' },
          { src: '/Justify/icons/icon-512.png', sizes: '512x512', type: 'image/png', purpose: 'any maskable' }
        ]
      },
      workbox: {
