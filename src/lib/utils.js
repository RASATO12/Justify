...
export const ACCEPT_AUDIO = 'audio/*,.mp3,.m4a,.flac,.aac,.wav,.ogg,.oga,.opus,.alac,.m4b,.wma,.aiff,.aif'
export const isAudioName = (n = '') => /\.(mp3|m4a|flac|aac|wav|ogg|oga|opus|alac|m4b|wma|aiff?)$/i.test(n)
